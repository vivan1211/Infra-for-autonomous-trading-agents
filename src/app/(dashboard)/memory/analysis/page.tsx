...
import { useWikiAnalysisLatest } from "@/hooks/use-wiki";
...
export default function AnalysisPage() {
  ...
  const week: string = a.week ?? a.week_label ?? "";
  const cost: any = a.cost ?? a.llm_cost ?? null;
  const hash: string = a.provenance_hash ?? a.content_hash ?? "";
  ...
  return (
    <>
      ...
      {narrative && (
        <div>
          <h2 className="text-[22px] font-semibold text-white">Narrative</h2>
